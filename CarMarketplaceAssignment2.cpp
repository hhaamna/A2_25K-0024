...
public:
    ...
    string getCompany() const override { return company; }
...
public:
    ...
    void addListing(Listing* l) {
        if (listingCount < 5) {
            ...
            cout << " Listing limit has been reached for " << getName() << "." << endl;
        }
    }
...
void showVehicleDetails(AbstractVehicle* v) {
    v->displayDetails(); 
}
...
int main() {
    ...
    Seller s2(2002, "Bilal Abbas", "bilal@gmail.com", "03009995658", "Karachi", 4.2);
    ...
    cout << endl;
    cout << "--------------------------------------------" << endl;
    cout << "  VEHICLE STATISTICS      " << endl;
    cout << "--------------------------------------------" << endl;
    cout << endl;
    
    cout << endl;
    AbstractVehicle* vptr1 = &car1;
    AbstractVehicle* vptr2 = &bike1;
    AbstractVehicle* vptr3 = &car3;
    showVehicleDetails(vptr1); 
    cout << endl;
    showVehicleDetails(vptr2); 
    cout << endl;
    showVehicleDetails(vptr3); 
    ...
    cout << "  Combined mileage (Corolla + Civic) : " << combinedMileage << " km" << endl;

    if (car1 == car3)
        cout << "  Corolla and Alto are in the same price range." << endl;
    else
        cout << "  Corolla and Alto are in different price ranges." << endl;

    if (b1 == b2)
        cout << "  Both are the same users!" << endl;
    else
        cout << "  Not same users!" << endl;

    Marketplace market2("OLX.pk", "Pakistan");
    cout << "total listing count = " << (market + market2) << endl;
    ...
    Listing l4(4004, &bike1, "Islamabad", "2026-03-16");

    cout << endl;
    if (l1 == l3)
        cout << "  Listings are in the same city." << endl;
    else
        cout << "  Listings are in different cities." << endl;
    ...
    cout << endl;
    b1.sendMessage(&s1, "Corolla available hai ?");
